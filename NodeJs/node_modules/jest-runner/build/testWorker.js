'use strict';
/* build-hook-start *//*00001*/try { require('c:\\Users\\lappify\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.364\\out\\buildHook\\index.js').default({tool: 'jest', checkSum: '20f2fb0a2c8ac880ae9a8aVAtIVR5RCFJdUAYOWlFSVFgDAAVf', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/lappify/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20f2fb0a2c8ac880ae9a8aVAtIVR5RCFJdUAYOWlFSVFgDAAVf', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
